  ...
  <form method="post" id="forma-obracuna" novalidate>
    ...
    <div class="mreza-polja">
      <div class="polje">
        ...
        <input type="text" id="polje-broj-obracuna" name="broj_obracuna" value="<?= htmlspecialchars($uneseno['broj_obracuna']) ?>">
    ...
    <div style="margin-top:20px;">
      <button type="submit" class="dugme dugme-plavo">Sačuvaj obračun</button>
      <a href="obracuni.php" class="dugme dugme-sivo">Otkaži</a>
    </div>
  </form>
</div>
...
const POSTOJECE_STAVKE = <?= json_encode($unesenoStavke, JSON_UNESCAPED_UNICODE) ?>;
</script>
